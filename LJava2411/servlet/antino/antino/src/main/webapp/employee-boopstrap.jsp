    ...
    <table class="table table-bordered table-hover mt-4">
        ...
        <c:forEach var="employeeModel" items="${employeeModels}">
            <tr>
                ...
                <td>
                    <a href="editEmployee?id=${employeeModel.employeeId}" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="deleteEmployee?id=${employeeModel.employeeId}" class="btn btn-danger btn-sm">
